<?php 
	...
	{
		include ("mysql.php");
		$requete2= "SELECTE 'mdp_administrateur' FROM 'administration'";
		$requete1= "SELECTE 'login_admin' FROM 'administration'";
		...
		else 
		{
			...
			unset($_SESSION);
			mysql_close($id_bd);
			echo "<script type='text/javascript'>document.location.replace('id_administration.php');</script>";
		}
